 ...
 * - EDITED: Revamped left column to premium editorial layout (light theme, pristine whitespace, Bloomberg/Mint style).
 */
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-slate-200 selection:text-slate-900 relative overflow-hidden">
