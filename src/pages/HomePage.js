...
const HomePage = () => {
    ...
    const defaultDescription = "Your trusted source for daily financial news, market updates, and expert analysis. Treishvaam Finance provides insights and education to build your financial confidence.";
