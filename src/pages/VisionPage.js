                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="relative max-w-2xl mx-auto">
                        ...
                        <div className="relative mb-12">
                            <div className="absolute w-8 h-8 bg-gradient-to-r from-sky-500 to-pink-500 rounded-full left-1/2 transform -translate-x-1/2 -translate-y-4 flex items-center justify-center text-white font-bold shadow-lg">1</div>
                        ...
                        <div className="relative mb-12">
                            <div className="absolute w-8 h-8 bg-gradient-to-r from-sky-500 to-pink-500 rounded-full left-1/2 transform -translate-x-1/2 -translate-y-4 flex items-center justify-center text-white font-bold shadow-lg">2</div>
                            <div className="bg-white p-6 rounded-xl shadow-lg w-full md:w-4/5 mx-auto">
                        ...
                        <div className="relative mb-12">
                            <div className="absolute w-8 h-8 bg-gradient-to-r from-sky-500 to-pink-500 rounded-full left-1/2 transform -translate-x-1/2 -translate-y-4 flex items-center justify-center text-white font-bold shadow-lg">3</div>
                            <div className="bg-white p-6 rounded-xl shadow-lg w-full md:w-4/5 mx-auto">
