...
const Footer = () => {
    ...
    const InstagramIcon = ({ width = 24, height = 24 }) => <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" role="img" width={width} height={height}><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.585-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.585-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.85s.011-3.585.069-4.85c.149-3.225 1.664-4.771 4.919-4.919C8.415 2.175 8.796 2.163 12 2.163zm0 1.441c-3.141 0-3.506.012-4.729.069-2.766.126-3.904 1.264-4.031 4.031-.057 1.223-.068 1.588-.068 4.729s.011 3.506.068 4.729c.127 2.767 1.265 3.904 4.031 4.031 1.223.057 1.588.068 4.729.068s3.506-.011 4.729-.068c2.767-.127 3.904-1.265 4.031-4.031-.057-1.223-.068-1.588-.068-4.729s-.011-3.506-.068-4.729c-.127-2.767-1.265-3.904-4.031-4.031-1.223-.057-1.588-.068-4.729-.068zm0 5.831a4.927 4.927 0 100 9.854 4.927 4.927 0 000-9.854zm0 8.413a3.486 3.486 0 110-6.972 3.486 3.486 0 010 6.972zm4.804-8.033a1.159 1.159 0 100-2.318 1.159 1.159 0 000 2.318z"/></svg>;
    ...
    return (
        <footer className="bg-gray-800 text-gray-300 py-12 min-h-[200px]">
