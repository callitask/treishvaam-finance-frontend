        ...
        <footer className="bg-gray-800 text-gray-300 py-12">
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              ...
              <div><h4 className="text-lg font-semibold text-white mb-4">Quick Links</h4><ul className="space-y-2"><li><Link to="/about" className="hover:text-sky-400 transition duration-300">About Us</Link></li><li><Link to="/vision" className="hover:text-sky-400 transition duration-300">Our Vision</Link></li><li><Link to="/education" className="hover:text-sky-400 transition duration-300">Education</Link></li><li><Link to="/blog" className="hover:text-sky-400 transition duration-300">Blog</Link></li><li><Link to="/contact" className="hover:text-sky-400 transition duration-300">Contact</Link></li></ul></div>
              <div><h4 className="text-lg font-semibold text-white mb-4">Contact Us</h4><ul className="space-y-2 text-sm"><li>Email: info@treishvaam.finance</li><li>Phone: (123) 456-7890</li><li>Address: 123 Finance St, Moneyville, FL</li></ul></div>
              <div><h4 className="text-lg font-semibold text-white mb-4">Follow Us</h4><div className="flex space-x-4"><a href="https://www.instagram.com/treishvaamfinance/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-white transition duration-300"><InstagramIcon /></a><a href="https://www.linkedin.com/company/treishvaamfinance/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-white transition duration-300"><LinkedInIcon /></a></div></div>
            </div>
