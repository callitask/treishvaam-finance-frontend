 ...
 * - EDITED: Reverted right column to original 'Secure Access' pillowy layout (centered, colored icons, rounded borders) for conversion trust. 
 * - EDITED: Upgraded left column to 'fintech-premium' modern aesthetic (geometric CSS glows, glassmorphic bento-box flasher).
 */
"use client";
...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFC] font-sans text-slate-900 selection:bg-sky-200 selection:text-sky-900 relative overflow-hidden -mx-4 sm:-mx-6 lg:-mx-8 flex flex-col">
            ...
            {/* Abstract glow spheres for depth */}
            ...
            <div className="flex-1 container mx-auto px-6 lg:px-12 flex flex-col justify-center py-12 lg:py-0 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="w-full lg:w-[60%] flex flex-col justify-center animate-fade-in-up pr-0 lg:pr-8">
                        ...
                        {/* Glassmorphic Bento Box News Flasher */}
                    ...
                    {/* RIGHT COLUMN: 40% - Trusted "Secure Access" Pillowy Portal */}
                    <div className="w-full lg:w-[40%] flex justify-center lg:justify-end mt-10 lg:mt-0">
                        <div className="w-full max-w-md bg-white border border-slate-100 shadow-2xl shadow-slate-200/60 rounded-2xl p-8 lg:p-10 relative z-10 transition-all hover:shadow-slate-300/50">
                            ...
                            <div className="space-y-3 mb-8">
                                <button onClick={handleLoginRedirect} className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all text-slate-700 text-sm font-medium shadow-sm">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <button onClick={handleLoginRedirect} className="flex items-center justify-center gap-2 px-4 py-3.5 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all text-slate-700 text-sm font-medium shadow-sm">
