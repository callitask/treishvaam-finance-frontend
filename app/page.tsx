 ...
 *
 * Purpose:
 * - Public Entry Point (Root "/"). Next.js App Router Migration.
 * - "Davos-Grade" Institutional Financial Landing Page.
 *
 * Scope:
 ...
 * - ADDED:
 * • Migrated from CRA to Next.js Page component.
 * • Changed `react-router-dom` imports to `next/link` and `next/navigation`.
 * • Added "use client" directive to support React hooks (useState, useEffect).
 * • Why: Phase 2 Next.js App Router migration.
 */
"use client";
...
import { getCategories, getTopGainers } from '../src/apiConfig';
import {
            ...
            <div className="container mx-auto px-6 lg:px-12 min-h-screen flex flex-col justify-center py-10">
              ...
              ======================= */}
                    <div className="w-full lg:w-[45%] flex flex-col justify-center animate-fade-in-up order-2 lg:order-1">
                        ...
                        {/* "EXPLORE COMMUNITY" AUTH CONTAINER (Bordered & Refined) */}
                        ...
                        <div className="mt-12 pt-8 border-t border-slate-100">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {loading ? (
                                    ...
                                    <>
                                        {/* Static Key Topics */}
                                        <Link href="/home" className="px-4 py-2 rounded-full border border-slate-200 text-xs font-bold text-slate-600 bg-white hover:bg-slate-900 hover:text-white hover:border-slate-900 transition-all shadow-sm">
                                            Macro Strategy
                                        </Link>
                                        {/* Dynamic Topics */}
                                        ...
                                        <Link href="/home" className="px-4 py-2 rounded-full border border-transparent text-xs font-bold text-sky-700 hover:underline">
                                            View All &rarr;
                                        </Link>
                                    </>
                                )}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="space-y-0">
                                        {loading ? (
                                            ...
                                            marketMovers.map((mover: any, idx) => {
                                                let changeVal = 0;
                                            ...
                                            [
                                                ...
                                                <div key={i} className="flex justify-between items-center py-2.5 border-b border-slate-100 last:border-0">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <span className="text-[10px] font-bold text-slate-500 hidden sm:block">{m.n}</span>
                                                    </div>
